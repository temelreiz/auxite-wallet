// scripts/winback-templates-inline.mjs
// Plain-JS mirror of src/lib/winback-email-templates.ts so the Node send
// script can render emails without a TS build step. Keep in sync.
...
function renderWinbackEmail({ title, bodyHtml, ctaText, ctaUrl, language, unsubUrl }) {
...
export function getWinbackEmail(stage, language, email, unsubToken) {
