  ...
  async headers() {
    const securityHeaders = [
      ...
      },
      {
        ...
        value: [
          "default-src 'self'",
          "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.googletagmanager.com https://*.google-analytics.com https://challenges.cloudflare.com https://cdn.jsdelivr.net https://*.sumsub.com https://connect.facebook.net https://global-stg.transak.com https://global.transak.com https://client.crisp.chat https://settings.crisp.chat https://js.stripe.com",
