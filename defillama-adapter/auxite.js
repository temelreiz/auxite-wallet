...
module.exports = {
  methodology:
    "AUM = on-chain totalSupply (grams) of each Auxite metal token on Base, valued at the issuer's published per-gram USD NAV for gold, silver, platinum and palladium. Each token represents 1 gram of allocated physical metal held in custody; on-chain supply equals reserves, with a signed proof-of-reserve attestation posted on Base.",
  base: {
    tvl,
  },
};
