...
const TOKEN_V8_ADDRESSES: Record<string, string> = {
  AUXG: process.env.NEXT_PUBLIC_AUXG_V8 || "0xE044a46907a99245F06d294352A80C6165B7Ab6e",
  AUXS: process.env.NEXT_PUBLIC_AUXS_V8 || "0xc7dd69aD99f09a090a2AEF09F80f70DDDB588FAD",
  AUXPT: process.env.NEXT_PUBLIC_AUXPT_V8 || "0x09bDA6990CAFfB3b9Df403E829FC1aed957cB880",
  AUXPD: process.env.NEXT_PUBLIC_AUXPD_V8 || "0x6a594A3cDc1Df2c72bF83Ba47768a5d4780bFD6A",
};
