  ...
  welcomeEN: {
    ...
    html: wrap(`
      ...
      <table style="width:100%;border-collapse:collapse">
        ...
        ${step("4", "Structured Yield", "Lease your metals through our Yield Architecture and earn returns while maintaining full ownership.")}
      ...
      ${cta("https://vault.auxite.io/dashboard", "GET STARTED")}
    `),
  },
  ...
  welcomeTR: {
    ...
    html: wrap(`
      ...
      <table style="width:100%;border-collapse:collapse">
        ...
        ${step("4", "Yapılandırılmış Getiri", "Metallerinizi Getiri Mimarisi ile kiralayın, tam mülkiyeti korurken getiri elde edin.")}
      ...
      ${cta("https://vault.auxite.io/dashboard", "BAŞLAYIN")}
    `),
  },
  ...
  welcomeFR: {
    ...
    html: wrap(`
      ...
      <table style="width:100%;border-collapse:collapse">
        ...
        ${step("4", "Rendement Structuré", "Louez vos métaux via notre Architecture de Rendement et générez des rendements tout en conservant la pleine propriété.")}
      ...
      ${cta("https://vault.auxite.io/dashboard", "COMMENCEZ")}
    `),
  },
  ...
  welcomeDE: {
    ...
    html: wrap(`
      ...
      <table style="width:100%;border-collapse:collapse">
        ...
        ${step("4", "Strukturierte Rendite", "Verleasen Sie Ihre Metalle über unsere Rendite-Architektur und erzielen Sie Erträge bei vollem Eigentumserhalt.")}
      ...
      ${cta("https://vault.auxite.io/dashboard", "LOSLEGEN")}
    `),
  },
  ...
  welcomeAR: {
    ...
    html: wrap(`
      ...
      <table style="width:100%;border-collapse:collapse;direction:rtl;text-align:right">
        ...
        ${step("4", "العائد المهيكل", "أجّر معادنك واحصل على عوائد مع الحفاظ على الملكية الكاملة.")}
      ...
      ${cta("https://vault.auxite.io/dashboard", "ابدأ الآن")}
    `),
  },
  ...
  welcomeRU: {
    ...
    html: wrap(`
      ...
      <table style="width:100%;border-collapse:collapse">
        ...
        ${step("4", "Структурированная доходность", "Сдавайте металлы в аренду и получайте доход, сохраняя полное право собственности.")}
      ...
      ${cta("https://vault.auxite.io/dashboard", "НАЧНИТЕ")}
    `),
  },
};
