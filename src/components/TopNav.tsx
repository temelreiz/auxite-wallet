                        ...
                        if (!connected) {
                          return (
                            <button
                              ...
                              className="flex items-center gap-1.5 px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-lg bg-amber-500 hover:bg-amber-600 text-white font-medium text-xs sm:text-sm transition-all"
                            >
