  ...
  return (
    <>
      ...
      >
        ...
        {/* Convert Button - Institutional styling: no gradient, no shadow */}
        <button
          onClick={handleConvert}
          className="w-full px-4 py-2.5 rounded-xl bg-slate-700 hover:bg-slate-600 text-white text-sm font-medium transition-colors flex items-center justify-center gap-2"
        >
