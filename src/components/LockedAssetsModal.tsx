...
const translations: Record<string, Record<string, string>> = {
  tr: {
    ...
    subtitle: "Fiziksel metal tahsisleri ve kiralama pozisyonları",
    allocations: "Fiziksel Tahsisler",
    allocationsDesc: "Kasa lokasyonlarına göre tahsis edilmiş metalleriniz",
    stakingPositions: "Kiralama Pozisyonları",
    stakingDesc: "Aktif kiralama pozisyonlarınız",
    noAllocations: "Henüz tahsis bulunmuyor",
    noPositions: "Henüz kiralama pozisyonu bulunmuyor",
    totalLocked: "Toplam",
  ...
  en: {
    ...
    subtitle: "Physical metal allocations and leasing positions",
    allocations: "Physical Allocations",
    allocationsDesc: "Your metals allocated to vault locations",
    stakingPositions: "Leasing Positions",
    stakingDesc: "Your active leasing positions",
    noAllocations: "No allocations yet",
    noPositions: "No leasing positions yet",
    totalLocked: "Total",
    estValue: "Est. Value",
    vault: "Vault",
    amount: "Amount",
  ...
  de: {
    ...
    subtitle: "Physische Metallzuweisungen und Leasing-Positionen",
    allocations: "Physische Zuweisungen",
    allocationsDesc: "Ihre Metalle, die Tresorstandorten zugewiesen sind",
    stakingPositions: "Leasing-Positionen",
    stakingDesc: "Ihre aktiven Leasing-Positionen",
    noAllocations: "Noch keine Zuweisungen",
    noPositions: "Noch keine Leasing-Positionen",
    totalLocked: "Gesamt",
    estValue: "Gesch. Wert",
    vault: "Tresor",
    amount: "Betrag",
  ...
  fr: {
    ...
    subtitle: "Allocations de métaux physiques et positions de leasing",
    allocations: "Allocations Physiques",
    allocationsDesc: "Vos métaux alloués aux emplacements de coffre",
    stakingPositions: "Positions de Leasing",
    stakingDesc: "Vos positions de leasing actives",
    noAllocations: "Aucune allocation pour le moment",
    noPositions: "Aucune position de leasing pour le moment",
    totalLocked: "Total",
    estValue: "Valeur Est.",
    vault: "Coffre",
    amount: "Montant",
  ...
  ar: {
    ...
    subtitle: "تخصيصات المعادن الفعلية ومراكز التأجير",
    allocations: "التخصيصات الفعلية",
    allocationsDesc: "معادنك المخصصة لمواقع الخزائن",
    stakingPositions: "مراكز التأجير",
    stakingDesc: "مراكز التأجير النشطة الخاصة بك",
    noAllocations: "لا توجد تخصيصات بعد",
    noPositions: "لا توجد مراكز تأجير بعد",
  ...
  ru: {
    ...
    subtitle: "Физические распределения металлов и позиции лизинга",
    allocations: "Физические Распределения",
    allocationsDesc: "Ваши металлы, распределённые по хранилищам",
    stakingPositions: "Позиции Лизинга",
    stakingDesc: "Ваши активные позиции лизинга",
    noAllocations: "Распределений пока нет",
    noPositions: "Позиций лизинга пока нет",
    totalLocked: "Всего",
