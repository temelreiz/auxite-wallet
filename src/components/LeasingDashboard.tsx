...
const translations: Record<string, Record<string, string>> = {
  tr: {
    metalStaking: "Kıymetli Maden Kiralaması",
    stakeAndEarn: "Kurumsal kıymetli maden kiralama programlarına katılın",
    totalLocked: "Toplam Taahhüt",
    activePositions: "Aktif Pozisyonlar",
    annualEarnings: "Yıllık Getiri",
    averageAPY: "Ortalama Kiralama Oranı",
    thisWeek: "bu hafta",
    earn: "Kiralama",
    myPositions: "Pozisyonlarım",
    autoInvest: "Otomatik Tahsis",
    availableOffers: "Kiralama Programları",
    selectMetalTokens: "Fiziksel destekli metal varlıklarınızı seçin ve kiralama programlarına katılın",
    ...
    onChain: "Zincir Üstü",
    yieldBenchmark: "Kiralama oranları kurumsal kıymetli maden kiralama pazarlarından türetilmiştir",
  },
  en: {
    metalStaking: "Precious Metals Leasing",
    stakeAndEarn: "Participate in institutional precious metals leasing programs",
    totalLocked: "Total Committed",
    activePositions: "Active Positions",
    annualEarnings: "Annual Returns",
    averageAPY: "Average Lease Rate",
    thisWeek: "this week",
    earn: "Leasing",
    myPositions: "My Positions",
    autoInvest: "Auto-Allocate",
    availableOffers: "Leasing Programs",
    selectMetalTokens: "Select your physically-backed metal holdings and participate in leasing programs",
    ...
    onChain: "On-Chain",
    yieldBenchmark: "Lease rates derived from institutional precious metals leasing markets",
  },
  de: {
    metalStaking: "Edelmetall-Leasing",
    stakeAndEarn: "Nehmen Sie an institutionellen Edelmetall-Leasing-Programmen teil",
    totalLocked: "Gesamt Gebunden",
    activePositions: "Aktive Positionen",
    annualEarnings: "Jährliche Erträge",
    averageAPY: "Durchschn. Leasingrate",
    thisWeek: "diese Woche",
    earn: "Leasing",
    myPositions: "Meine Positionen",
    autoInvest: "Auto-Allokation",
    availableOffers: "Leasing-Programme",
    selectMetalTokens: "Wählen Sie Ihre physisch gedeckten Metallbestände und nehmen Sie an Leasing-Programmen teil",
    ...
    onChain: "On-Chain",
    yieldBenchmark: "Leasingraten abgeleitet aus institutionellen Edelmetall-Leasing-Märkten",
  },
  fr: {
    metalStaking: "Location de Métaux Précieux",
    stakeAndEarn: "Participez aux programmes institutionnels de location de métaux précieux",
    totalLocked: "Total Engagé",
    activePositions: "Positions Actives",
    annualEarnings: "Rendements Annuels",
    averageAPY: "Taux de Location Moyen",
    thisWeek: "cette semaine",
    earn: "Leasing",
    myPositions: "Mes Positions",
    autoInvest: "Auto-Allocation",
    availableOffers: "Programmes de Leasing",
    selectMetalTokens: "Sélectionnez vos avoirs métalliques et participez aux programmes de leasing",
    ...
    onChain: "On-Chain",
    yieldBenchmark: "Taux de location dérivés des marchés institutionnels de location de métaux précieux",
  },
  ar: {
    metalStaking: "تأجير المعادن الثمينة",
    stakeAndEarn: "شارك في برامج تأجير المعادن الثمينة المؤسسية",
    totalLocked: "إجمالي الالتزام",
    activePositions: "المراكز النشطة",
    annualEarnings: "العوائد السنوية",
    averageAPY: "متوسط معدل التأجير",
    thisWeek: "هذا الأسبوع",
    earn: "التأجير",
    myPositions: "مراكزي",
    autoInvest: "التخصيص التلقائي",
    availableOffers: "برامج التأجير",
    selectMetalTokens: "اختر حيازاتك المعدنية وشارك في برامج التأجير",
    ...
    onChain: "على السلسلة",
    yieldBenchmark: "معدلات التأجير مشتقة من أسواق تأجير المعادن الثمينة المؤسسية",
  },
  ru: {
    metalStaking: "Лизинг Драгоценных Металлов",
    stakeAndEarn: "Участвуйте в институциональных программах лизинга драгоценных металлов",
    totalLocked: "Всего Обязательств",
    activePositions: "Активные Позиции",
    annualEarnings: "Годовые Доходы",
    averageAPY: "Средняя Ставка Лизинга",
    thisWeek: "на этой неделе",
    earn: "Лизинг",
    myPositions: "Мои Позиции",
    autoInvest: "Авто-аллокация",
    availableOffers: "Программы Лизинга",
    selectMetalTokens: "Выберите ваши металлические активы и участвуйте в программах лизинга",
    ...
    onChain: "В Сети",
    yieldBenchmark: "Ставки лизинга получены из институциональных рынков лизинга драгоценных металлов",
  },
};
