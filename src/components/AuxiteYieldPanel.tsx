...
const translations: Record<string, Record<string, string>> = {
  tr: {
    title: "Getiri Projeksiyonu — Çoklu Metal",
    subtitle: "AUXG, AUXS, AUXPT ve AUXPD için kurumsal getiri projeksiyonu.",
    metalSelection: "Metal seçimi",
    initialAmount: "Tahsis miktarı (gram)",
    duration: "Vade",
    month: "Ay",
    metal: "Metal",
    annualRate: "Öngörülen Getiri Oranı",
    selectedDuration: "Seçilen Vade",
    totalYield: "Öngörülen Yapılandırılmış Getiri",
