...
const translations: Record<string, Record<string, string>> = {
  tr: {
    title: "Getiri Simülasyonu — Çoklu Metal",
    ...
    month: "Ay",
    metal: "Metal",
    annualRate: "Varsayımsal Yıllık Getiri",
    selectedDuration: "Seçilen Vade",
    totalYield: "Tahmini Getiri",
  ...
  de: {
    ...
    month: "Mo",
    metal: "Metall",
    annualRate: "Prognostizierte Jahresrendite",
    selectedDuration: "Gewählte Laufzeit",
    totalYield: "Prognostizierte Erträge",
  ...
  fr: {
    ...
    subtitle: "Projection de rendement institutionnel pour AUXG, AUXS, AUXPT et AUXPD.",
    metalSelection: "Sélection du métal",
    initialAmount: "Montant d'allocation (grammes)",
    duration: "Durée du Terme",
    month: "Mois",
    metal: "Métal",
    annualRate: "Rendement Annuel Projeté",
    selectedDuration: "Terme Sélectionné",
    totalYield: "Rendements Projetés",
    endTotal: "À Maturité",
  ...
  ar: {
    ...
    subtitle: "إسقاط العائد المؤسسي لـ AUXG و AUXS و AUXPT و AUXPD.",
    metalSelection: "اختيار المعدن",
    initialAmount: "مبلغ التخصيص (جرام)",
    duration: "مدة الاستثمار",
    month: "شهر",
    metal: "المعدن",
    annualRate: "العائد السنوي المتوقع",
    selectedDuration: "المدة المختارة",
    totalYield: "العوائد المتوقعة",
    endTotal: "عند الاستحقاق",
    disclaimer: "هذا مجرد إسقاط؛ ليس نصيحة استثمارية. العوائد غير مضمونة.",
  },
  ru: {
    title: "Проекция Дохода — Мульти Металл",
    subtitle: "Институциональная проекция доходности для AUXG, AUXS, AUXPT и AUXPD.",
    metalSelection: "Выбор металла",
    initialAmount: "Сумма аллокации (грамм)",
    duration: "Срок",
    month: "Мес",
    metal: "Металл",
    annualRate: "Прогнозируемый Годовой Доход",
    selectedDuration: "Выбранный Срок",
    totalYield: "Прогнозируемый Доход",
