...
const translations = {
  tr: {
    welcomeTitle: "Auxite Kasanıza Hoş Geldiniz",
    welcomeSubtitle: "Kıymetli metal varlıklarınız için güvenli dijital saklama",
    createNewWallet: "Yeni Kasa Oluştur",
    importWallet: "Mevcut Kasayı İçe Aktar",
  ...
  en: {
    ...
    welcomeSubtitle: "Secure digital custody for your precious metal assets",
    createNewWallet: "Create New Vault",
    importWallet: "Import Existing Vault",
  ...
  de: {
    ...
    welcomeSubtitle: "Sichere digitale Verwahrung für Ihre Edelmetall-Vermögenswerte",
    createNewWallet: "Neuen Tresor erstellen",
    importWallet: "Bestehenden Tresor importieren",
  ...
  fr: {
    ...
    welcomeSubtitle: "Garde numérique sécurisée pour vos actifs en métaux précieux",
    createNewWallet: "Créer un nouveau coffre",
    importWallet: "Importer un coffre existant",
