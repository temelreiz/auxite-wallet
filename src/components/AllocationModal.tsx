...
const translations: Record<string, Record<string, string>> = {
  tr: {
    ...
    headerSub: "Tahsis edilmiş metali kurumsal kiralama programlarına yönlendirin.",
  ...
  en: {
    ...
    headerSub: "Deploy allocated metal into institutional leasing programs.",
  ...
  de: {
    ...
    headerSub: "Allokiertes Metall in institutionelle Leasing-Programme einsetzen.",
  ...
  fr: {
    ...
    headerSub: "Déployer le métal alloué dans des programmes de leasing institutionnel.",
  ...
  ar: {
    ...
    headerSub: "نشر المعدن المخصص في برامج التأجير المؤسسية.",
  ...
  ru: {
    ...
    headerSub: "Размещение аллоцированного металла в институциональные программы лизинга.",
