...
const ASSETS: Record<AssetType, AssetInfo> = {
  ...
  AUXG: { name: { tr: "Altın", en: "Gold", de: "Gold", fr: "Or", ar: "ذهب", ru: "Золото" }, icon: "/auxg_icon.png", iconType: "image", category: "metal", color: "#F59E0B", unit: "AUXG" },
  AUXS: { name: { tr: "Gümüş", en: "Silver", de: "Silber", fr: "Argent", ar: "فضة", ru: "Серебро" }, icon: "/auxs_icon.png", iconType: "image", category: "metal", color: "#94A3B8", unit: "AUXS" },
  AUXPT: { name: { tr: "Platin", en: "Platinum", de: "Platin", fr: "Platine", ar: "بلاتين", ru: "Платина" }, icon: "/auxpt_icon.png", iconType: "image", category: "metal", color: "#CBD5E1", unit: "AUXPT" },
  AUXPD: { name: { tr: "Paladyum", en: "Palladium", de: "Palladium", fr: "Palladium", ar: "بالاديوم", ru: "Палладий" }, icon: "/auxpd_icon.png", iconType: "image", category: "metal", color: "#64748B", unit: "AUXPD" },
