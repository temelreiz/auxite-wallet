...
const translations: Record<string, Record<string, string>> = {
  ...
  de: {
    title: "Handel",
    subtitle: "Edelmetalle kaufen und verkaufen",
    selectMetal: "ZIELMETALL",
    goldDesc: "London Good Delivery",
    silverDesc: "LBMA Good Delivery",
    platinumDesc: "LPPM Good Delivery",
    palladiumDesc: "LPPM Good Delivery",
    allocatedSegregated: "Zugeteilt & getrennt",
    capitalDeployed: "Kapital eingesetzt",
    fundingSource: "ABRECHNUNGSVERMÖGEN",
    marketReference: "Marktreferenz (LBMA)",
    executionPrice: "Ausführungspreis",
    estimatedAllocation: "Geschätzte Zuteilung",
    reviewAllocation: "Zuteilung prüfen",
    allocationPreview: "Zuteilungsvorschau",
    metal: "Metall",
    structure: "Struktur",
    fullyAllocated: "Vollständig zugeteilt",
    vault: "Tresor",
    titleHolder: "Titelinhaber",
    clientVault: "Kundentresor",
    legalTitle: "Der Rechtstitel wird nach Ausführung in Ihrem Kundentresor erfasst.",
    confirmExecution: "Zuteilung bestätigen",
    cancel: "Abbrechen",
    executionNote: "Die Ausführung dauert nach Bestätigung in der Regel wenige Minuten.",
    allocationCompleted: "Zuteilung abgeschlossen",
    allocationId: "Zuteilungs-ID",
    viewCertificate: "Zertifikat anzeigen",
    enterProgram: "Programm beitreten",
    allocateMore: "Mehr zuteilen",
    rfqTitle: "Institutionelle Angebotsanfrage",
    rfqDescription: "Zuteilungen dieser Größe werden über unseren institutionellen Desk ausgeführt.",
    requestQuote: "Angebot anfordern",
    rfqSubmitted: "Ihre Anfrage wurde an den Desk weitergeleitet.",
    institutionalExecution: "Institutionelle Ausführungsinfrastruktur.",
    executionError: "Zuteilungsfehler",
    allocationFailed: "Zuteilung fehlgeschlagen. Bitte versuchen Sie es erneut.",
    connectionError: "Verbindungsfehler. Bitte versuchen Sie es erneut.",
  },
  fr: {
    title: "Trading",
    subtitle: "Acheter et vendre des métaux précieux",
    selectMetal: "MÉTAL CIBLE",
    goldDesc: "London Good Delivery",
    silverDesc: "LBMA Good Delivery",
    platinumDesc: "LPPM Good Delivery",
    palladiumDesc: "LPPM Good Delivery",
    allocatedSegregated: "Alloué & ségrégué",
    capitalDeployed: "Capital déployé",
    fundingSource: "ACTIF DE RÈGLEMENT",
    marketReference: "Référence marché (LBMA)",
    executionPrice: "Prix d'exécution",
    estimatedAllocation: "Allocation estimée",
    reviewAllocation: "Revoir l'allocation",
    allocationPreview: "Aperçu de l'allocation",
    metal: "Métal",
    structure: "Structure",
    fullyAllocated: "Entièrement alloué",
    vault: "Coffre",
    titleHolder: "Titulaire",
    clientVault: "Coffre client",
    legalTitle: "Le titre légal sera enregistré dans votre coffre client après exécution.",
    confirmExecution: "Confirmer l'allocation",
    cancel: "Annuler",
    executionNote: "L'exécution se termine généralement en quelques minutes après confirmation.",
    allocationCompleted: "Allocation terminée",
    allocationId: "ID d'allocation",
    viewCertificate: "Voir le certificat",
    enterProgram: "Rejoindre le programme",
    allocateMore: "Allouer davantage",
    rfqTitle: "Demande de cotation institutionnelle",
    rfqDescription: "Les allocations de cette taille sont exécutées via notre desk institutionnel.",
    requestQuote: "Demander un devis",
    rfqSubmitted: "Votre demande a été transmise au desk.",
    institutionalExecution: "Infrastructure d'exécution institutionnelle.",
    executionError: "Erreur d'allocation",
    allocationFailed: "Allocation échouée. Veuillez réessayer.",
    connectionError: "Erreur de connexion. Veuillez réessayer.",
  },
  ar: {
    title: "تداول",
    subtitle: "شراء وبيع المعادن الثمينة",
    selectMetal: "المعدن المستهدف",
    goldDesc: "London Good Delivery",
    silverDesc: "LBMA Good Delivery",
    platinumDesc: "LPPM Good Delivery",
    palladiumDesc: "LPPM Good Delivery",
    allocatedSegregated: "مخصص ومنفصل",
    capitalDeployed: "رأس المال المنشور",
    fundingSource: "أصل التسوية",
    marketReference: "مرجع السوق (LBMA)",
    executionPrice: "سعر التنفيذ",
    estimatedAllocation: "التخصيص المقدر",
    reviewAllocation: "مراجعة التخصيص",
    allocationPreview: "معاينة التخصيص",
    metal: "المعدن",
    structure: "الهيكل",
    fullyAllocated: "مخصص بالكامل",
    vault: "الخزنة",
    titleHolder: "صاحب الملكية",
    clientVault: "خزنة العميل",
    legalTitle: "سيتم تسجيل الملكية القانونية في خزنة العميل عند التنفيذ.",
    confirmExecution: "تأكيد التخصيص",
    cancel: "إلغاء",
    executionNote: "يكتمل التنفيذ عادة في غضون دقائق بعد التأكيد.",
    allocationCompleted: "اكتمل التخصيص",
    allocationId: "معرف التخصيص",
    viewCertificate: "عرض الشهادة",
    enterProgram: "الانضمام للبرنامج",
    allocateMore: "تخصيص المزيد",
    rfqTitle: "طلب عرض سعر مؤسسي",
    rfqDescription: "يتم تنفيذ التخصيصات بهذا الحجم عبر مكتبنا المؤسسي.",
    requestQuote: "طلب عرض سعر",
    rfqSubmitted: "تم إرسال طلبك إلى المكتب.",
    institutionalExecution: "بنية تنفيذ مؤسسية.",
    executionError: "خطأ في التخصيص",
    allocationFailed: "فشل التخصيص. يرجى المحاولة مرة أخرى.",
    connectionError: "خطأ في الاتصال. يرجى المحاولة مرة أخرى.",
  },
  ru: {
    title: "Торговля",
    subtitle: "Покупка и продажа драгоценных металлов",
    selectMetal: "ЦЕЛЕВОЙ МЕТАЛЛ",
    goldDesc: "London Good Delivery",
    silverDesc: "LBMA Good Delivery",
    platinumDesc: "LPPM Good Delivery",
    palladiumDesc: "LPPM Good Delivery",
    allocatedSegregated: "Размещено и обособлено",
    capitalDeployed: "Капитал задействован",
    fundingSource: "РАСЧЁТНЫЙ АКТИВ",
    marketReference: "Рыночная справка (LBMA)",
    executionPrice: "Цена исполнения",
    estimatedAllocation: "Расчётное размещение",
    reviewAllocation: "Проверить размещение",
    allocationPreview: "Предварительный просмотр",
    metal: "Металл",
    structure: "Структура",
    fullyAllocated: "Полностью размещено",
    vault: "Хранилище",
    titleHolder: "Владелец титула",
    clientVault: "Хранилище клиента",
    legalTitle: "Юридическое право собственности будет зарегистрировано в вашем хранилище после исполнения.",
    confirmExecution: "Подтвердить размещение",
    cancel: "Отмена",
    executionNote: "Исполнение обычно завершается в течение нескольких минут после подтверждения.",
    allocationCompleted: "Размещение завершено",
    allocationId: "ID размещения",
    viewCertificate: "Просмотреть сертификат",
    enterProgram: "Вступить в программу",
    allocateMore: "Разместить ещё",
    rfqTitle: "Запрос институциональной котировки",
    rfqDescription: "Размещения такого объёма выполняются через наш институциональный деск.",
    requestQuote: "Запросить котировку",
    rfqSubmitted: "Ваш запрос передан на деск.",
    institutionalExecution: "Институциональная инфраструктура исполнения.",
    executionError: "Ошибка размещения",
    allocationFailed: "Ошибка размещения. Попробуйте снова.",
...
export default function AllocatePage() {
  ...
  }, [isExecuting, selectedSource, selectedMetal, capitalAmount, estimatedGrams, address, metalExecPrice, inputAmount, isStablecoinSource]);
