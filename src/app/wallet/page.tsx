  ...
  return (
    <div className="min-h-screen bg-stone-100 dark:bg-slate-950">
      ...
      <div className="max-w-5xl mx-auto px-4 py-6 space-y-4">
        ...
        <div className="flex items-center justify-center gap-2 py-3 px-4 bg-[#2F6F62]/10 dark:bg-[#2F6F62]/10 rounded-xl border border-[#2F6F62]/30 dark:border-[#2F6F62]/30/50">
          {[
            { key: "fullyAllocated", label: t.fullyAllocated },
            { key: "segregated", label: t.segregated },
            { key: "bankruptcyRemote", label: t.bankruptcyRemote },
      ...
      {trustBadgeModal && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => setTrustBadgeModal(null)}
              className="px-6 py-2.5 bg-[#2F6F62] text-white font-semibold rounded-xl hover:bg-[#2F6F62] transition-colors"
            >
              {t.close}
            </button>
          </div>
