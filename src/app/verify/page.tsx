    ...
    <main className="max-w-2xl mx-auto px-4 py-12">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 mb-6">
        ...
        <div className="flex gap-3">
          <input
            ...
            className="flex-1 px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
      ...
      {result && (
        <div className="space-y-6">
          <div className={`rounded-2xl p-6 ${result.verified ? 'bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800' : 'bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800'}`}>
            <div className="flex items-center gap-4">
              <div className={`w-12 h-12 rounded-full flex items-center justify-center ${result.verified ? 'bg-emerald-500' : 'bg-red-500'}`}>
                {result.verified ? (
              ...
              <div>
                <h2 className={`text-xl font-bold ${result.verified ? 'text-emerald-700 dark:text-emerald-400' : 'text-red-700 dark:text-red-400'}`}>
            ...
            <>
              ...
              {result.blockchain && (
                <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                  ...
                  <div className="p-6 space-y-4">
                    <div className="flex items-center gap-3">
                      <div className={`w-3 h-3 rounded-full ${result.blockchain.anchored ? 'bg-emerald-500' : 'bg-amber-500'}`} />
                      <span className={`font-medium ${result.blockchain.anchored ? 'text-emerald-600 dark:text-emerald-400' : 'text-amber-600 dark:text-amber-400'}`}>
