                  ...
                  >
                    {!connected && (
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl bg-amber-500 hover:bg-amber-600 text-white font-semibold text-sm sm:text-base transition-all shadow-lg shadow-emerald-500/20"
                      >
