...
const demoStakeTranslations: Record<string, Record<string, string>> = {
  ...
  tr: {
    ...
    demoYieldMessage: "Demo metallerinizi kiralayarak simüle edilmiş getiri elde edin.",
    demoMetalBalance: "Demo Metal Varlıklarınız",
    backToVault: "Kasaya Dön",
    selectMetal: "Kiralanacak Metali Seçin",
    amount: "Miktar (gram)",
    selectTerm: "Vade Seçin",
    months3: "3 Ay",
    months6: "6 Ay",
    months12: "12 Ay",
    estimatedYield: "Tahmini Getiri",
    apy: "APY",
    startLease: "Kirayı Başlat",
    processing: "İşleniyor...",
    leaseSuccess: "Kira Başladı",
    leaseSuccessMsg: "{amount}g {metal} metaliniz {term} süreyle %{apy} APY ile kiralanmıştır. Tahmini getiri: {yield}g",
    leaseAnother: "Daha Fazla Kirala",
    activeLeases: "Aktif Demo Kiraları",
